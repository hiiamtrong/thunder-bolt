...
```bash
cp .env.default .env  && npm install // run this CMD on first run
yarn start:dev
```

Then use ngrok to public your app

```bash
ngrok http 1235 // PORT of your app
```

After that

Open [Event Subscriptions](https://api.slack.com/apps/A026T8K6R4N/event-subscriptions?) in slack app and change Request URL

![Link Demo](https://i.ibb.co/fvqJ3sy/image.png)
